...
const quotes = [
  ...
  {quote: "Spread love everywhere you go. Let no one ever come to you without leaving happier.", source: "Mother Teresa", citation: "blog.hubspot.com", year: "2023"},
  {quote: "Try not to become a man of success, but rather try to become a man of value.", source: "Albert Einstein"},
  {quote: "The difference between winning and losing is most often not quitting", source: "Walt Disney"}
];
